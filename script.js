...
if(hora==="12:00:00"){
dias[dia].dayIcon=item.weather[0].icon;
}

if(hora==="21:00:00"){
dias[dia].nightIcon=item.weather[0].icon;
}
...
const nomeDia=d.toLocaleDateString("pt-PT",{weekday:"long"});

const max=Math.round(Math.max(...dias[dia].temps));
const min=Math.round(Math.min(...dias[dia].temps));

let iconDay=dias[dia].dayIcon || "01d";
let iconNight=dias[dia].nightIcon || "01n";

let stormIcon=dias[dia].storm ? "⚡" : "";
...
<img src="https://openweathermap.org/img/wn/${iconDay}.png">

<img src="https://openweathermap.org/img/wn/${iconNight}.png">
